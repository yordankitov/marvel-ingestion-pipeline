...
def test_invalid_url_raises_exception():
    ...
    with pytest.raises(Exception):
        requests.get('https://gateway.marvel.com:443/v1/c/characters?ts=1&limit=5&apikey=eef4a51f95df748e9c1effea6cc244f2&hash=fdc2fde7473f59a1544c0471493d6e1a&orderBy=modified&offset=0')